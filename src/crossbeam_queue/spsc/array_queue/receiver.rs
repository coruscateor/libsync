...
use crate::{ChannelSharedDetails, ReceiveError, ReceiveResult, SendResult, LimitedSingleWakerMultiPermit};
...
pub struct Receiver<T>
{
    ...
    shared_details: Arc<ChannelSharedDetails<ArrayQueue<T>, LimitedSingleWakerMultiPermit>>,
    senders_count: Weak<()>,
    receivers_count: Arc<()>
...
impl<T> Receiver<T>
{
    ...
    /// 
    pub fn new(shared_details: Arc<ChannelSharedDetails<ArrayQueue<T>, LimitedSingleWakerMultiPermit>>, senders_count: Weak<()>, receivers_count: Arc<()>) -> Self
    {
