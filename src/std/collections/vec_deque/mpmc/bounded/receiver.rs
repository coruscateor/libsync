...
impl<T> Receiver<T>
{
    ...
    #[cfg(feature="tokio")]
    pub async fn recv_timeout_tokio(&self, duration: Duration) -> Result<Result<T, ()>, Elapsed>
    {
    ...
    #[cfg(feature="tokio")]
    pub async fn recv_timeout_at_tokio(&self, deadline: Instant) -> Result<Result<T, ()>, Elapsed>
    {
    ...
    pub fn downgrade(&self) -> WeakReceiver<T>
    {
        ...
        WeakReceiver::new(&self.shared_details, self.senders_count.clone(), &self.receivers_count)
